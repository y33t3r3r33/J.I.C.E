...
public class ArmHighBasket extends SequentialCommandGroup {
    private ArmANGSUB armang;
    private IntakeSUB intake;

    public ArmHighBasket(ArmANGSUB armang, IntakeSUB intake) {
        this.armang = armang;
        this.intake = intake;
    ...
    public void initialize() {
        addCommands( new ParallelCommandGroup(new ArmANGCOMM(this.armang, Config.PivotHighBasketSetpoint),
                        new IntakeCOMM(this.intake, Config.ExtensionHighBasketSetpoint))
